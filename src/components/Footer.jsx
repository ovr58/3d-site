const Footer = () => {
  return (
    <footer className="bg-tertiary-900 text-center text-white">
      <div className="px-6 pt-6">
        <div className="mb-6 flex justify-center">
          ...
          {/* <a
            href="#!"
            type="button"
            className="m-1 h-9 w-9 rounded-full border-2 border-white uppercase leading-normal text-white transition duration-150 ease-in-out hover:bg-blue-900 hover:animate-bounce focus:outline-none focus:ring-0"
            data-te-ripple-init
            data-te-ripple-color="light"
          >
            <svg
